...
cp "./ddwDome.png" "$TheSkyX_Path/Resources/Common/PlugInsARM32/DomePlugIns/"
...
if [ ! -z "$app_owner" ]; then
	...
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugInsARM32/DomePlugIns/ddwDome.png"
