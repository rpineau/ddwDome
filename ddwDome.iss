...
#define MyAppName "TI DDW X2 PlugIn"
...
AppId={{EE951E78-A8B8-4537-910B-70680FC20E32}
AppName={#MyAppName}
...
OutputBaseFilename=ddwDome_X2_Installer
...
[Files]
Source: "domelist ddwDome.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist ddwDome.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 ddwDome.txt"
; 32 bits
Source: "libddwDome\Win32\Release\libddwDome.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
Source: "ddwDome.ui";                               DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libddwDome\x64\Release\libddwDome.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "ddwDome.ui";                               DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
